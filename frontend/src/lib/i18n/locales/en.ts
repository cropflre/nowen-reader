...
const en: Translations = {
  ...
  scraper: {
    ...
    modeAIDesc: "AI parse filename → online search → AI completion, with fallback",
    ...
    emptyDesc: "Choose a scrape mode and scope, then click \"Start Scraping\" to auto-fetch covers, descriptions, tags from online sources. AI mode can parse filenames for better matching.",
    ...
    modeAIShort: "AI parse + search + complete",
