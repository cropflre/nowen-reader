...
func registerMetadataRoutes(api *gin.RouterGroup) {
	...
	opdsGroup.Use(middleware.OPDSAuthRequired())
	{
		...
		opdsGroup.GET("/collections", opds.Collections)
		opdsGroup.GET("/collections/:id", opds.CollectionDetail)
		opdsGroup.GET("/collections/:id/cover", opds.CollectionCover)
		opdsGroup.GET("/series", opds.Series)
		opdsGroup.GET("/series/:id", opds.SeriesDetail)
		opdsGroup.GET("/series/:id/cover", opds.SeriesCover)
